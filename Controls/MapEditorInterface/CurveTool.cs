...
{
    public partial class CurveTool : UserControl, IMapEditorTool
    {
        ...
        public CheckBox GetToolButton()
        {
            ...
            chk.BackgroundImage = Properties.Resources.scribble;
        ...
        public void ToolMouseDoubleClick(MapEditorControl sender, MouseEventArgs e)
        {
            if(_points.Count>1){
                using(Graphics g = Graphics.FromImage(sender.CurrentImage)){
                    g.DrawCurve(new Pen(sender.ForeBrush),_points.ToArray());
                }
            }
        }
