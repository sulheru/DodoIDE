...
{
    public partial class BrushTool : UserControl, IMapEditorTool
    {
        ...
        public CheckBox GetToolButton()
        {
            ...
            chk.BackgroundImage = Properties.Resources.Brush;
        ...
        public void ToolMouseDown(MapEditorControl sender, MouseEventArgs e)
        {
            if(e.Button==MouseButtons.Left) {
                ((Bitmap)sender.CurrentImage).SetPixel(e.X,e.Y,sender.ForeBrush.Color);
            } else if(e.Button==MouseButtons.Right) {
                ((Bitmap)sender.CurrentImage).SetPixel(e.X,e.Y,sender.BackBrush.Color);
            }
        }
