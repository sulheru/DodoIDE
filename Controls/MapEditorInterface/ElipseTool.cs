...
{
    public partial class ElipseTool : UserControl, IMapEditorTool
    {
        Point _start;
        ...
        public CheckBox GetToolButton()
        {
            ...
            chk.BackgroundImage = Properties.Resources.ellipse_outline_shape_variant;
        ...
        public void ToolMouseMove(MapEditorControl sender, MouseEventArgs e)
        {
            if(e.Button==MouseButtons.Left){
                using(Graphics g=sender.CreateGraphics()){
                    ...
                    g.FillEllipse(sender.ForeBrush,r);
                    g.DrawEllipse(new Pen(sender.BackBrush),r);
                }
                sender.Refresh();
            }
        }
